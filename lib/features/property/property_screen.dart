...
//
//
// // 📍 [최종 수정] 마이너스 마진을 사용하여 AppBar 내의 + 버튼 바로 옆으로 위치 고정
// class _FloatingGuideArrow extends StatefulWidget {
...
//   @override
//   Widget build(BuildContext context) {
//     // 📍 핵심 수정: top을 마이너스 값으로 설정하여 AppBar 아이콘 높이와 일치시킴
//     return Positioned(
//       top: -42, // AppBar 영역 안쪽으로 버튼을 끌어올림
//       right: 48, // + 아이콘 바로 왼쪽에 위치하도록 간격 조정
//       child: AnimatedBuilder(
//         animation: _animation,
//         builder: (context, child) {
//           return Transform.translate(
//             offset: Offset(-_animation.value, 0), // 수평으로 톡톡 치는 애니메이션
//             child: Container(
//               padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
//               decoration: BoxDecoration(
//                 color: Colors.orangeAccent.withOpacity(0.95), // 시인성을 위해 불투명도 상향
