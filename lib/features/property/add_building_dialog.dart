...
class _AddBuildingDialogState extends ConsumerState<AddBuildingDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Text(isEdit ? "PROP_EDIT_BUILDING".tr(ref) : "PROP_ADD_BUILDING".tr(ref)),
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("PROP_PHOTO_HINT".tr(ref), style: const TextStyle(color: Colors.grey, fontSize: 13)),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: Text(isEdit ? "COMMON_SAVE".tr(ref) : "COMMON_CONFIRM".tr(ref)),
        ),
      ],
    );
  }
